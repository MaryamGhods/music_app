...
import { Discover, TopArtists, TopSongs, ArtistDetails, SongDetails, Search } from './pages'
import { Sidebar, TopPlay, MusicPlayer, Searchbar } from './components'
          ...
          <div className="flex-1 h-fit mb-8">
            ...
            <div className='z-0'>
              <Routes>
                ...
                <Route path="/songs/:songName" element={<SongDetails />} />
